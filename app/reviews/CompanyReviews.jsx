                    ...
                    <div className="row">
                        <div className="col-sm-5">
                            <div className="rating-block">
                                ...
                                <h2 className="bold padding-bottom-7">4.3
                                    <small>/ 5</small>
                                </h2>
                        ...
                        <div>
                            <div className="col-sm-7">
                                ...
                                <div className="pull-left">
                                    ...
                                    <div className="pull-right" style={{marginLeft: '10px', marginRight: '10px'}}>1234
                                    </div>
                                </div>
                                <div className="pull-left">
                                    <div className="pull-left" style={{width: '35px', lineHeight: '1px'}}>
                            ...
                            <div className="review-block">
                                <div className="row">
                                    ...
                                    <div className="col-sm-7">
                                        ...
                                        <div className="review-block-description">Great company. Very friendly people
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-7">
                                        ...
                                        <div className="review-block-description">Watch out for this company. Poor
                                            service, save your cash
                                        </div>
                                    </div>
                                </div>
                            </div>
